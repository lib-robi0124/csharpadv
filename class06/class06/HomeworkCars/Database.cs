...
namespace HomeworkCars
{
    public static class DataBase
    {
        public static List<Car> Cars = new List<Car>()
        {
           ...
           new Car() { Model = "Volkswagen Type 3", MilesPerGalon = 23, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 54, Origin = "Europe", Weight = 2254 },
           new Car() { Model = "Chevrolet Vega", MilesPerGalon = 20, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 90, Origin = "US", Weight = 2408 },
           new Car() { Model = "Ford Pinto Runabout", MilesPerGalon = 21, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 86, Origin = "US", Weight = 2226 },
           ...
           new Car() { Model = "Plymouth Fury III", MilesPerGalon = 15, AccelerationTime = 15.5, Cylinders = 8, HorsePower = 150, Origin = "US", Weight = 4135 },
           new Car() { Model = "Ford Galaxie 500", MilesPerGalon = 14, AccelerationTime = 13, Cylinders = 8, HorsePower = 153, Origin = "US", Weight = 4129 },
           new Car() { Model = "AMC Ambassador SST", MilesPerGalon = 17, AccelerationTime = 15.5, Cylinders = 8, HorsePower = 150, Origin = "US", Weight = 3672 },
           new Car() { Model = "Mercury Marquis", MilesPerGalon = 11, AccelerationTime = 11, Cylinders = 8, HorsePower = 208, Origin = "US", Weight = 4633 },
           new Car() { Model = "Buick LeSabre Custom", MilesPerGalon = 13, AccelerationTime = 15.5, Cylinders = 8, HorsePower = 155, Origin = "US", Weight = 4502 },
           new Car() { Model = "Oldsmobile Delta 88 Royale", MilesPerGalon = 12, AccelerationTime = 15.5, Cylinders = 8, HorsePower = 160, Origin = "US", Weight = 4456 },
           new Car() { Model = "Chrysler Newport Royal", MilesPerGalon = 13, AccelerationTime = 15.5, Cylinders = 8, HorsePower = 190, Origin = "US", Weight = 4422 },
           new Car() { Model = "Mazda RX2 Coupe", MilesPerGalon = 19, AccelerationTime = 15.5, Cylinders = 3, HorsePower = 97, Origin = "Japan", Weight = 2330 },
           new Car() { Model = "AMC Matador (sw)", MilesPerGalon = 15,  AccelerationTime = 15.5, Cylinders = 8, HorsePower = 150, Origin = "US", Weight = 3892 },
           ...
           new Car() { Model = "Volvo 145e (sw)", MilesPerGalon = 18, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 112, Origin = "Europe", Weight = 2933 },
           new Car() { Model = "Volkswagen 411 (sw)", MilesPerGalon = 22, AccelerationTime = 18, Cylinders = 4, HorsePower = 76, Origin = "Europe", Weight = 2511 },
           new Car() { Model = "Peugeot 504 (sw)", MilesPerGalon = 21, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 87, Origin = "Europe", Weight = 2979 },
           ...
           new Car() { Model = "Toyota Corolla Mark II (sw)", MilesPerGalon = 23,   AccelerationTime = 15.5, Cylinders = 4, HorsePower = 97, Origin = "Japan", Weight = 2506 },
           new Car() { Model = "Dodge Colt (sw)", MilesPerGalon = 28, AccelerationTime = 15, Cylinders = 4, HorsePower = 80, Origin = "US", Weight = 2164 },
           new Car() { Model = "Toyota Corolla 1600 (sw)", MilesPerGalon = 27, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 88, Origin = "Japan", Weight = 2100 },
           new Car() { Model = "Buick Century 350", MilesPerGalon = 13, AccelerationTime = 13, Cylinders = 8, HorsePower = 175, Origin = "US", Weight = 4100 },
           new Car() { Model = "AMC Matador", MilesPerGalon = 14, AccelerationTime = 15.5, Cylinders = 8, HorsePower = 150, Origin = "US", Weight = 3672 },
           new Car() { Model = "Chevrolet Malibu", MilesPerGalon = 13, AccelerationTime = 13, Cylinders = 8, HorsePower = 145, Origin = "US", Weight = 3988 },
           new Car() { Model = "Ford Gran Torino", MilesPerGalon = 14, AccelerationTime = 15.5, Cylinders = 8, HorsePower = 137, Origin = "US", Weight = 4042 },
           new Car() { Model = "Dodge Coronet Custom", MilesPerGalon = 15, AccelerationTime = 15.5, Cylinders = 8, HorsePower = 150, Origin = "US", Weight = 3777 },
           new Car() { Model = "Mercury Marquis Brougham", MilesPerGalon = 12, AccelerationTime = 15.5, Cylinders = 8, HorsePower = 198, Origin = "US", Weight = 4952 },
           ...
           new Car() { Model = "Plymouth Fury Gran Sedan", MilesPerGalon = 14, AccelerationTime = 15.5, Cylinders = 8, HorsePower = 150, Origin = "US", Weight = 4237 },
           ...
           new Car() { Model = "Plymouth Valiant", MilesPerGalon = 18, AccelerationTime = 15.5, Cylinders = 6, HorsePower = 105, Origin = "US", Weight = 3121 },
           ...
           new Car() { Model = "Ford Maverick", MilesPerGalon = 18, AccelerationTime = 15.5, Cylinders = 6, HorsePower = 88, Origin = "US", Weight = 3021 },
           ...
           new Car() { Model = "Ford Country", MilesPerGalon = 12, AccelerationTime = 15.5, Cylinders = 8, HorsePower = 167, Origin = "US", Weight = 4906 },
           ...
           new Car() { Model = "Oldsmobile Vista Cruiser", MilesPerGalon = 12, AccelerationTime = 15.5, Cylinders = 8, HorsePower = 180, Origin = "US", Weight = 4499 },
           ...
           new Car() { Model = "Chevrolet Vega", MilesPerGalon = 21, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 72, Origin = "US", Weight = 2401 },
           new Car() { Model = "Datsun 610", MilesPerGalon = 22, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 94, Origin = "Japan", Weight = 2379 },
           new Car() { Model = "Mazda RX3", MilesPerGalon = 18, AccelerationTime = 15.5, Cylinders = 3, HorsePower = 90, Origin = "Japan", Weight = 2124 },
           new Car() { Model = "Ford Pinto", MilesPerGalon = 19, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 85, Origin = "US", Weight = 2310 },
           ...
           new Car() { Model = "Pontiac Grand Prix", MilesPerGalon = 16, AccelerationTime = 15.5, Cylinders = 8, HorsePower = 230, Origin = "US", Weight = 4278 },
           new Car() { Model = "Fiat 128", MilesPerGalon = 29, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 49, Origin = "Europe", Weight = 1867 },
           ...
           new Car() { Model = "Toyota Mark II", MilesPerGalon = 20, AccelerationTime = 15.5, Cylinders = 6, HorsePower = 122, Origin = "Japan", Weight = 2807 },
           new Car() { Model = "Oldsmobile Omega", MilesPerGalon = 11, AccelerationTime = 11, Cylinders = 8, HorsePower = 180, Origin = "US", Weight = 3664 },
           new Car() { Model = "Plymouth Duster", MilesPerGalon = 20, AccelerationTime = 15.5, Cylinders = 6, HorsePower = 95, Origin = "US", Weight = 3102 },
           ...
           new Car() { Model = "Ford Pinto", MilesPerGalon = 26, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 80, Origin = "US", Weight = 2451 },
           ...
           new Car() { Model = "Plymouth Satellite Sebring", MilesPerGalon = 18, AccelerationTime = 15.5, Cylinders = 6, HorsePower = 105, Origin = "US", Weight = 3613 },
           new Car() { Model = "Ford Gran Torino", MilesPerGalon = 16, AccelerationTime = 14, Cylinders = 8, HorsePower = 140, Origin = "US", Weight = 4141 },
           new Car() { Model = "Buick Century Luxus (sw)", MilesPerGalon = 13, AccelerationTime = 15.5, Cylinders = 8, HorsePower = 150, Origin = "US", Weight = 4699 },
           new Car() { Model = "Dodge Coronet Custom (sw)", MilesPerGalon = 14, AccelerationTime = 15.5, Cylinders = 8, HorsePower = 150, Origin = "US", Weight = 4457 },
           ...
           new Car() { Model = "Audi Fox", MilesPerGalon = 29, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 83, Origin = "Europe", Weight = 2219 },
           ...
           new Car() { Model = "Opel Manta", MilesPerGalon = 26, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 78, Origin = "Europe", Weight = 2300 },
           new Car() { Model = "Toyota Corolla", MilesPerGalon = 31, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 52, Origin = "Japan", Weight = 1649 },
           new Car() { Model = "Datsun 710", MilesPerGalon = 32, AccelerationTime = 19, Cylinders = 4, HorsePower = 61, Origin = "Japan", Weight = 2003 },
           new Car() { Model = "Dodge Colt", MilesPerGalon = 28, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 75, Origin = "US", Weight = 2125 },
           ...
           new Car() { Model = "Ford Maverick", MilesPerGalon = 15, AccelerationTime = 15.5, Cylinders = 6, HorsePower = 72, Origin = "US", Weight = 3158 },
           new Car() { Model = "Pontiac Catalina", MilesPerGalon = 16, AccelerationTime = 15.5, Cylinders = 8, HorsePower = 170, Origin = "US", Weight = 4668 },
           new Car() { Model = "Chevrolet Bel Air", MilesPerGalon = 15, AccelerationTime = 14, Cylinders = 8, HorsePower = 145, Origin = "US", Weight = 4440 },
           new Car() { Model = "Plymouth Grand Fury", MilesPerGalon = 16, AccelerationTime = 15.5, Cylinders = 8, HorsePower = 150, Origin = "US", Weight = 4498 },
           new Car() { Model = "Ford LTD", MilesPerGalon = 14, AccelerationTime = 15.5, Cylinders = 8, HorsePower = 148, Origin = "US", Weight = 4657 },
           new Car() { Model = "Buick Century", MilesPerGalon = 17, AccelerationTime = 21, Cylinders = 6, HorsePower = 110, Origin = "US", Weight = 3907 },
           new Car() { Model = "Chevrolete Chevelle Malibu", MilesPerGalon = 16, AccelerationTime = 15.5, Cylinders = 6, HorsePower = 105, Origin = "US", Weight = 3897 },
           ...
           new Car() { Model = "Chevrolet Monza 2+2", MilesPerGalon = 20, AccelerationTime = 15.5, Cylinders = 8, HorsePower = 110, Origin = "US", Weight = 3221 },
           ...
           new Car() { Model = "Pontiac Astro", MilesPerGalon = 23, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 78, Origin = "US", Weight = 2592 },
           new Car() { Model = "Toyota Corolla", MilesPerGalon = 24, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 96, Origin = "Japan", Weight = 2702 },
           new Car() { Model = "Volkswagen Dasher", MilesPerGalon = 25, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 71, Origin = "Europe", Weight = 2223 },
           new Car() { Model = "Datsun 710", MilesPerGalon = 24, AccelerationTime = 17, Cylinders = 4, HorsePower = 97, Origin = "Japan", Weight = 2545 },
           new Car() { Model = "Ford Pinto", MilesPerGalon = 18, AccelerationTime = 15.5, Cylinders = 6, HorsePower = 97, Origin = "US", Weight = 2984 },
           ...
           new Car() { Model = "Volvo 244DL", MilesPerGalon = 22, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 98, Origin = "Europe", Weight = 2945 },
           new Car() { Model = "Saab 99LE", MilesPerGalon = 25, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 115, Origin = "Europe", Weight = 2671 },
           new Car() { Model = "Honda Civic CVCC", MilesPerGalon = 33, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 53, Origin = "Japan", Weight = 1795 },
           new Car() { Model = "Fiat 131", MilesPerGalon = 28, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 86, Origin = "Europe", Weight = 2464 },
           new Car() { Model = "Opel 1900", MilesPerGalon = 25, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 81, Origin = "Europe", Weight = 2220 },
           new Car() { Model = "Capri ii", MilesPerGalon = 25, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 92, Origin = "US", Weight = 2572 },
           new Car() { Model = "Dodge Colt", MilesPerGalon = 26, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 79, Origin = "US", Weight = 2255 },
           new Car() { Model = "Renault 12tl", MilesPerGalon = 27, AccelerationTime = 15.3, Cylinders = 4, HorsePower = 83, Origin = "Europe", Weight = 2202 },
           new Car() { Model = "Chevrolet Chevelle Malibu Classic", MilesPerGalon = 17, AccelerationTime = 13, Cylinders = 8, HorsePower = 140, Origin = "US", Weight = 4215 },
           ...
           new Car() { Model = "Ford Gran Torino", MilesPerGalon = 14.5, AccelerationTime = 13.9, Cylinders = 8, HorsePower = 152, Origin = "US", Weight = 4215 },
           new Car() { Model = "Plymouth Valiant", MilesPerGalon = 22, AccelerationTime = 15.5, Cylinders = 6, HorsePower = 100, Origin = "US", Weight = 3233 },
           new Car() { Model = "Chevrolet Nova", MilesPerGalon = 22, AccelerationTime = 15.5, Cylinders = 6, HorsePower = 105, Origin = "US", Weight = 3353 },
           new Car() { Model = "Ford Maverick", MilesPerGalon = 24, AccelerationTime = 15.5, Cylinders = 6, HorsePower = 81, Origin = "US", Weight = 3012 },
           new Car() { Model = "AMC Hornet", MilesPerGalon = 22 , AccelerationTime = 13.9, Cylinders = 6, HorsePower = 90, Origin = "US", Weight = 3085 },
           new Car() { Model = "Chevrolet Chevette", MilesPerGalon = 29, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 52, Origin = "US", Weight = 2035 },
           new Car() { Model = "Chevrolet Woody", MilesPerGalon = 24.5, AccelerationTime = 13.9, Cylinders = 4, HorsePower = 60, Origin = "US", Weight = 2164 },
           new Car() { Model = "Volkswagen Rabbit", MilesPerGalon = 29, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 70, Origin = "Europe", Weight = 1937 },
           new Car() { Model = "Honda Civic", MilesPerGalon = 33, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 53, Origin = "Japan", Weight = 1795 },
           new Car() { Model = "Dodge Aspen SE", MilesPerGalon = 20, AccelerationTime = 15.5, Cylinders = 6, HorsePower = 100, Origin = "US", Weight = 3651 },
           new Car() { Model = "Ford Grenada ghia", MilesPerGalon = 18, AccelerationTime = 21, Cylinders = 6, HorsePower = 78, Origin = "US", Weight = 3574 },
           new Car() { Model = "Pontiac Ventura SJ", MilesPerGalon = 18.5, AccelerationTime = 13.9, Cylinders = 6, HorsePower = 110, Origin = "US", Weight = 3645 },
           new Car() { Model = "AMC Pacer d/l", MilesPerGalon = 17.5, AccelerationTime = 15.5, Cylinders = 6, HorsePower = 95, Origin = "US", Weight = 3193 },
           new Car() { Model = "Volkswagen Rabbit", MilesPerGalon = 29.5, AccelerationTime = 13.9, Cylinders = 4, HorsePower = 71, Origin = "Europe", Weight = 1825 },
           new Car() { Model = "Datsun B-210", MilesPerGalon = 32, AccelerationTime = 17, Cylinders = 4, HorsePower = 70, Origin = "Japan", Weight = 1990 },
           new Car() { Model = "Toyota Corolla", MilesPerGalon = 28, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 75, Origin = "Japan", Weight = 2155 },
           new Car() { Model = "Ford Pinto", MilesPerGalon = 26.5, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 72, Origin = "US", Weight = 2565 },
           new Car() { Model = "Volvo 245", MilesPerGalon = 20, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 102, Origin = "Europe", Weight = 3150 },
           new Car() { Model = "Plymouth Volare Premier v8", MilesPerGalon = 13, AccelerationTime = 15.5, Cylinders = 8, HorsePower = 150, Origin = "US", Weight = 3940 },
           new Car() { Model = "Peugeot 504", MilesPerGalon = 19, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 88, Origin = "Europe", Weight = 3270 },
           new Car() { Model = "Toyota Mark II", MilesPerGalon = 19, AccelerationTime = 15.5, Cylinders = 6, HorsePower = 108, Origin = "Japan", Weight = 2930 },
           new Car() { Model = "Mercedes-Benz 280s", MilesPerGalon = 24.5, AccelerationTime = 13.9, Cylinders = 6, HorsePower = 120, Origin = "Europe", Weight = 3820 },
           new Car() { Model = "Cadillac Seville", MilesPerGalon = 29.5, AccelerationTime = 13.9, Cylinders = 8, HorsePower = 180, Origin = "US", Weight = 4380 },
           ...
           new Car() { Model = "Honda Accord CVCC", MilesPerGalon = 31.5, AccelerationTime = 13.9, Cylinders = 4, HorsePower = 68, Origin = "Japan", Weight = 2045 },
           new Car() { Model = "Buick Opel Isuzu Deluxe", MilesPerGalon = 30, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 80, Origin = "US", Weight = 2155 },
           new Car() { Model = "Renault 5 GTL", MilesPerGalon = 36, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 58, Origin = "Europe", Weight = 1825 },
           ...
           new Car() { Model = "Mercury Cougar Brougham", MilesPerGalon = 15, AccelerationTime = 15.5, Cylinders = 8, HorsePower = 130, Origin = "US", Weight = 4295 },
           ...
           new Car() { Model = "Plymouth Volare Custom", MilesPerGalon = 19, AccelerationTime = 15.5, Cylinders = 6, HorsePower = 100, Origin = "US", Weight = 3630 },
           ...
           new Car() { Model = "Datsun 810", MilesPerGalon = 2, AccelerationTime = 14.5, Cylinders = 6, HorsePower = 97, Origin = "Japan", Weight = 2815 },
           ...
           new Car() { Model = "Chevrolet Monte Carlo Landau", MilesPerGalon = 19.2, AccelerationTime = 132, Cylinders = 8, HorsePower = 145, Origin = "US", Weight = 3425 },
           ...
           new Car() { Model = "Toyota Corolla", MilesPerGalon = 27.5, AccelerationTime = 1.2, Cylinders = 4, HorsePower = 95, Origin = "Japan", Weight = 2560 },
           ...
           new Car() { Model = "Pontiac Lemans V6", MilesPerGalon = 21.5, AccelerationTime = 1.4, Cylinders = 6, HorsePower = 115, Origin = "US", Weight = 3245 },
           ...
           new Car() { Model = "Ford LTD Landau", MilesPerGalon = 17.6, AccelerationTime = 134, Cylinders = 8, HorsePower = 129, Origin = "US", Weight = 3725 },
           new Car() { Model = "Mercury Grand Marquis", MilesPerGalon = 16.5, AccelerationTime = 1.2, Cylinders = 8, HorsePower = 138, Origin = "US", Weight = 3955 },
           ...
           new Car() { Model = "Mazda GLC Deluxe", MilesPerGalon = 34.1, AccelerationTime = 1.1, Cylinders = 4, HorsePower = 65, Origin = "Japan", Weight = 1975 },
           ...
           new Car() { Model = "Mercedes Benz 300d", MilesPerGalon = 19.2, AccelerationTime = 20.1, Cylinders = 5, HorsePower = 77, Origin = "Europe", Weight = 3530 },
           new Car() { Model = "Cadillac Eldorado", MilesPerGalon = 23, AccelerationTime = 17.4, Cylinders = 8, HorsePower = 125, Origin = "US", Weight = 3900 },
           new Car() { Model = "Peugeot 504", MilesPerGalon = 19.2, AccelerationTime = 24.8, Cylinders = 4, HorsePower = 71, Origin = "Europe", Weight = 3190 },
           new Car() { Model = "Oldsmobile Cutlass Salon Brougham", MilesPerGalon = 15.5, AccelerationTime = 22.2, Cylinders = 8, HorsePower = 90, Origin = "US", Weight = 3420 },
           new Car() { Model = "Plymouth Horizon", MilesPerGalon = 35.7, AccelerationTime = 13.2, Cylinders = 2, HorsePower = 70, Origin = "US", Weight = 2200 },
           new Car() { Model = "Plymouth Horizon TC3", MilesPerGalon = 3.5, AccelerationTime = 14.9, Cylinders = 4, HorsePower = 70, Origin = "US", Weight = 2150 },
           new Car() { Model = "Datsun 210", MilesPerGalon = 31.8, AccelerationTime = 19.2, Cylinders = 4, HorsePower = 65, Origin = "Japan", Weight = 2020 },
           new Car() { Model = "Fiat Strada Custom", MilesPerGalon = 19.2, AccelerationTime = 14.7, Cylinders = 4, HorsePower = 69, Origin = "Europe", Weight = 2130 },
           ...
           new Car() { Model = "Volkswagen Rabbit", MilesPerGalon = 19.2, AccelerationTime = 14.7, Cylinders = 4, HorsePower = 76, Origin = "Europe", Weight = 2144 },
           ...
           new Car() { Model = "Audi 4000", MilesPerGalon = 19.2, AccelerationTime = 15.8, Cylinders = 4, HorsePower = 78, Origin = "Europe", Weight = 2188 },
           new Car() { Model = "Toyota Corolla Liftback", MilesPerGalon = 28, AccelerationTime = 15.5, Cylinders = 4, HorsePower = 90, Origin = "Japan", Weight = 2711 },
           ...
           new Car() { Model = "Volkswagen Rabbit C (Diesel)", MilesPerGalon = 19.2, AccelerationTime = 21.7, Cylinders = 4, HorsePower = 48, Origin = "Europe", Weight = 2085 },
           new Car() { Model = "Volkswagen Dasher (diesel)", MilesPerGalon = 19.2, AccelerationTime = 23.7, Cylinders = 4, HorsePower = 48, Origin = "Europe", Weight = 2335 },
           new Car() { Model = "Audi 5000s (diesel)", MilesPerGalon = 19.2, AccelerationTime = 19.9, Cylinders = 5, HorsePower = 67, Origin = "Europe", Weight = 2950 },
           ...
           new Car() { Model = "Renault Lecar Deluxe", MilesPerGalon = 19.2, AccelerationTime = 17.3, Cylinders = 4, HorsePower = 0, Origin = "Europe", Weight = 1835 },
           new Car() { Model = "Subaru DL", MilesPerGalon = 33.8, AccelerationTime = 18, Cylinders = 4, HorsePower = 67, Origin = "Japan", Weight = 2145 },
           new Car() { Model = "Volkswagen Rabbit", MilesPerGalon = 19.2, AccelerationTime = 15.3, Cylinders = 4, HorsePower = 62, Origin = "Europe", Weight = 1845 },
           ...
           new Car() { Model = "Dodge Aries Wagon (sw)", MilesPerGalon = 25.8, AccelerationTime = 14.3, Cylinders = 4, HorsePower = 92, Origin = "US", Weight = 2620 },
           new Car() { Model = "Chevrolet Citation", MilesPerGalon = 23.5, AccelerationTime = 15.7, Cylinders = 6, HorsePower = 110, Origin = "US", Weight = 2725 },
           ...
           new Car() { Model = "Plymouth Champ", MilesPerGalon = 39, AccelerationTime = 1.4, Cylinders = 4, HorsePower = 64, Origin = "US", Weight = 1875 },
           ...
           new Car() { Model = "Ford Ranger", MilesPerGalon = 28, AccelerationTime = 16.9, Cylinders = 4, HorsePower = 79, Origin = "US", Weight = 2625 },
